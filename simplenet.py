...
if __name__ == '__main__':
    ...
    parser.add_option("-o", "--modelPath", dest="modelPath", default="/tmp/simplenet/model.470")
    parser.add_option("-c", "--checkpointPath", dest="checkpointPath", default="/tmp/simplenet")
    ...
    sc = SparkContext(appName="simplenet", conf=create_spark_conf())
    redire_spark_logs()
